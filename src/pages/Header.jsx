        ...
        {["/", "/about", "/contact","/generate-plan"].map((path, index) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`absolute left-0 right-0 h-0.5 transition-transform duration-300 ${
                  isActive ? "scale-x-100 bg-blue-600" : "scale-x-0"
...
// Optional Dumbbell Icon (if needed elsewhere)
