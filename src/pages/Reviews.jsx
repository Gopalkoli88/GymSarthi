...
//   return (
//     <div className="w-full max-w-3xl mx-auto  text-white overflow-hidden">
//       <div
//         ref={carouselRef}
...
//           <div
//             key={index}
//             className="flex-shrink-0 w-full bg-black p-6 rounded-lg"
//           >
//             <div className="flex items-center justify-between gap-4">
//               <div className="flex items-center gap-4">
//                 <div className="w-10 h-10 border flex items-center justify-center rounded-full bg-gray-800 text-white">
